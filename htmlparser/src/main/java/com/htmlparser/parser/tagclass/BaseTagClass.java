...
public abstract class BaseTagClass {
    ...
    public BaseTagClass(HtmlElement element, String className) {
    ...
    public static BaseTagClass parseFromString(String string, Creators creators) {
        ...
        if (fullClassName.contains("p.")) {
            ...
            clazz = new TagBody(HtmlElement.BODY, null);
    ...
    public boolean equals(Object o) {
        ...
        BaseTagClass cssClass = (BaseTagClass) o;
